...
process BAM_FILTER {
    ...
    output:
    tuple val(meta), path("*_${params.reference_genome}.bam"), path("*_${params.spikein_genome}.bam") ,  emit: bam
    //tuple val(meta), path("*_${params.reference_genome}.bam.bai"), path("*_${params.spikein_genome}.bam.bai"), emit : bai
    ...
    samtools view \\
        ...
        -b $refbam \\
        | bamtools filter \\
            -out ${prefix}_${params.reference_genome}.bam \\
            -script $config
    ...
    samtools view \\
        ...
        -b $spikebam \\
        | bamtools filter \\
            -out ${prefix}_${params.spikein_genome}.bam \\
            -script $config
